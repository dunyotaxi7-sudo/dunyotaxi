...
export function YandexLiveMap({
  ...
  return (
    <div className="relative h-full">
      ...
      {selected && (
        // Top-left, not bottom-left: the Yandex JS API pins its own "Открыть
        // Яндекс Карты" control to the bottom-left corner, and it sat on top of
        // this card — hiding the car number, which is the one thing an operator
        // opens the card to read.
        <div className="absolute left-3 top-3 z-10 card px-3 py-2 shadow-[var(--shadow-md)] max-w-[260px]">
